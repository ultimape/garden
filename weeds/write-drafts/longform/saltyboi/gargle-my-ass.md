...
(This first part is a rewritten bit of some some tweets I wrote back in March 12, 2020)
...
I'm thinking if we can use effective gargling in a medical settings we might be able to prevent build up in nasal/mouth/throat before it gets enough to enter lungs and overwhelm immune system? May also help prevent/slow spread.

So gargle iodized salt?
...
[Coronavirus disease (COVID-19) advice for the public: Myth busters](https://web.archive.org/web/20200312051930/https://who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/myth-busters) [MAR 2022]
...
Doesn't this count as evidence? I don't see how they can say with a straight face that there is \*no\* evidence any preventative measure we haven't bothered to test at scale has any effective power against "novel coronavirus". However there *is* evidence that salt water does have action against Coronavirus in general, and a low power clinical trial suggests it might work. But I'm sure that this is just a *Myth*. Sure is awfully kind of the world health organization to tell me that.

How do we... Uh... Get access to a large number of potential cases to run a clinical trial on the use of salt water gargle as a partial preventative measure against contracting the common cold? You'd think cases would be hard to find... /s

----

Some time later... 

Now, to follow up on this idea in September 28th, 2023. Just in time to see a rise in covid cases and concerns over spreading...
...
The other one I noticed they removed was Garlic. I wonder how long until they remove the Hot Pepper one, cuz it turns out that taking hot pepper in your food may indirectly prevent coughs and could reduce the spread that way. But what do I know? I'm not a doctor.
